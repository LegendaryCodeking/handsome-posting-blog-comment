...
const shortDescription = (0, express_validator_1.body)("shortDescription").isString().withMessage("test message").trim().isLength({ min: 1, max: 100 }).withMessage("shortDescription should be string with length from 1 to 15 symbols");
