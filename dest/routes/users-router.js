...
exports.usersRouter.get('/', auth_mw_1.authenticationCheck, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
...
exports.usersRouter.post('/', auth_mw_1.authenticationCheck, uservalidation_mw_1.loginValidation, uservalidation_mw_1.passwordValidation, uservalidation_mw_1.emailValidation, inputErrorsCheck_mw_1.inputValidationMw, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
...
exports.usersRouter.delete('/:id', auth_mw_1.authenticationCheck, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
